...
<script src="{{ URL::asset('web_assets/js/jquery.js') }}"></script>
<script src="{{ URL::asset('web_assets/js/bootstrap.js') }}"></script>
<script src="{{ URL::asset('web_assets/js/respond.min.js') }}"></script>
<script src="{{ URL::asset('web_assets/js/application.js') }}"></script>
<script src="{{ URL::asset('web_assets/js/bootstrap-tooltip.js') }}"></script>
<script defer src="{{ URL::asset('web_assets/js/jquery.fancybox.js') }}"></script>
<script defer src="{{ URL::asset('web_assets/js/jquery.flexslider.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('web_assets/js/jquery.tweet.js') }}"></script>
<script  src="{{ URL::asset('web_assets/js/cloud-zoom.1.0.2.js') }}"></script>
<script  type="text/javascript" src="{{ URL::asset('web_assets/js/jquery.validate.js') }}"></script>
<script type="text/javascript"  src="{{ URL::asset('web_assets/js/jquery.carouFredSel-6.1.0-packed.js') }}"></script>
<script type="text/javascript"  src="{{ URL::asset('web_assets/js/jquery.mousewheel.min.js') }}"></script>
