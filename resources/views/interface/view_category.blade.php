...
@section ('content')
    <ol class="breadcrumb">
        <li><a href="{{ URL::route('admin.categories.index') }}"><span>All Categories</span></a></li>
        <li><a href="{{ URL::route('admin.categories.show', $category->id) }}"><span>{{ $category->category_name }}</span></a></li>
    </ol>
